(function() {
	...
	document.addEventListener('DOMContentLoaded', function() {
		...
		if (document.getElementById('mapa')) {
			var map = L.map('mapa').setView([ 4.678915, -74.058366 ], 16);

			L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png').addTo(map);

			L.marker([ 4.678915, -74.058366 ]).addTo(map).bindPopup('GDLWebCAMP 2020').openPopup();
	...
	$(function() {
		...
		$('.cuenta-regresiva').countdown('2020/10/10 13:00:00', function(event) {
